...
You can also pass `--terminal=inplace` for the same effect on a one-off basis. Without shell integration it uses AppleScript or dbus to “type” into the current terminal.
